!(function (e, t, r) {
  ...
  Object.assign(o.prototype, { update: function () {} });
  var s,
    l =
      ((s = new Set()),
      function (e) {
  ...
  function c(t) {
    t = t || {};
    var r = (this.params1 = new e.Vector4(
        void 0 !== t.stiffness ? t.stiffness : 1700,
        void 0 !== t.damping ? t.damping : 6,
        void 0 !== t.radius ? t.radius : 0.5,
        1e6
      )),
      a = (this.params2 = new e.Vector4(
        void 0 !== t.fixedTimeStep ? t.fixedTimeStep : 1 / 120,
        void 0 !== t.friction ? t.friction : 2,
        void 0 !== t.drag ? t.drag : 0.1,
        void 0 !== t.centerParticleIndex ? t.centerParticleIndex : -1
      ));
    ...
    (this.params4 = new e.Vector4(0, 0, 0, 0)),
      ...
      (this.onpoststep = t.onpoststep || function () {}),
      (this.time = 0),
      (this.fixedTime = 0),
      ...
      t.boxMin && this.boxMin.copy(t.boxMin),
      t.boxMax && this.boxMax.copy(t.boxMax),
      t.gridPosition && this.broadphase.position.copy(t.gridPosition),
      t.gridResolution && this.broadphase.resolution.copy(t.gridResolution),
      ...
      (this.maxSubSteps = void 0 !== t.maxSubSteps ? t.maxSubSteps : 5),
      (this.accumulator = 0),
    ...
    Object.defineProperties(this, {
      ...
      l(),
      this.initTextures(t.maxParticles || 8),
      Object.assign(this.materials, {
        textured: new e.ShaderMaterial({
          uniforms: {
            texture: { value: null },
            res: { value: new e.Vector2() },
          },
          vertexShader: n,
          fragmentShader: i,
        }),
    ...
    this.scenes.fullscreen.add(d),
      (this.cellSize = new e.Vector2(this.radius, this.radius).multiplyScalar(
        2
      ));
  }
  function d(e, t, r) {
  ...
  Object.assign(c.prototype, {
    getDefines: function (t) {
      ...
      return Object.assign({}, t || {}, {
        resolution: m(
          new e.Vector2(this.particleTextureSize, this.particleTextureSize)
        ),
        gridResolution: m(r),
    ...
    step: function (e) {
      ...
      if (!(e < 0 || r <= 0)) {
        t += e;
        for (var i = 0; t >= r; )
          i < this.maxSubSteps && this.singleStep(), (t -= r), i++;
    ...
    connectParticles(e, t, r) {
      ...
      function n(r) {
        for (
          var n,
            a,
            o = p(e, r.image.width, r.image.height),
            s = p(t, r.image.width, r.image.height),
            l = 0;
          l < 4;
          l++
        )
    ...
    initTextures: function (t) {
      var r = /(iPad|iPhone|iPod)/g.test(navigator.userAgent)
          ? e.HalfFloatType
          : e.FloatType,
        i = (function (e) {
      ...
      Object.assign(this.textures, {
        ...
        grid: x(
          2 * this.broadphase.resolution.x,
          2 * this.broadphase.resolution.y,
          r
        ),
        explode: x(1, 1, r),
        exploded: x(1, 1, r),
        ...
        Object.assign(this.dataTextures, {
          particles: new e.DataTexture(
            new Float32Array(4 * i * i),
            i,
            i,
            e.RGBAFormat,
            r
          ),
          mass: new e.DataTexture(
            new Float32Array(4 * i * i),
            i,
            i,
            e.RGBAFormat,
          ...
          springsDiagonal: new e.DataTexture(
            new Float32Array(4 * i * i),
            i,
            i,
            e.RGBAFormat,
    ...
    flushData: function () {
      this.time > 0 ||
        (this.flushDataToRenderTarget(
          this.textures.particleWrite,
          this.dataTextures.particles
        ),
        this.flushDataToRenderTarget(
          this.textures.particleRead,
          this.dataTextures.particles
        ),
        this.flushDataToRenderTarget(
          this.textures.springsRead,
          this.dataTextures.springs
        ),
        this.flushDataToRenderTarget(
          this.textures.springsDiagonalRead,
          this.dataTextures.springsDiagonal
        ));
    },
    flushDataToRenderTarget: function (e, t) {
      var r = this.materials.textured;
      (r.uniforms.texture.value = t),
        r.uniforms.res.value.set(e.width, e.height),
        (this.fullscreenQuad.material = r),
        this.renderer.render(
          this.scenes.fullscreen,
          this.fullscreenCamera,
          e,
          !0
        ),
        (r.uniforms.texture.value = null),
    ...
    setRenderTargetSubData: function (t, r, i, n) {
      ...
      if (!this.scenes.setParticleData) {
        ...
        o
          .addAttribute(
            "position",
            new e.BufferAttribute(new Float32Array(384), 3)
          )
          .addAttribute("data", new e.BufferAttribute(l, 4))
          .addAttribute("particleIndex", new e.BufferAttribute(s, 1)),
          (this.setParticleDataMesh = new e.Points(
            o,
            this.materials.setParticleData
          )),
      ...
      for (
        var c = new e.Vector4(),
          d = this.onePointPerParticleGeometry.attributes,
          u = 0;
        u < t.length;
        u += 128
      ) {
    ...
    resetGridStencil: function () {
      if (void 0 === this.scenes.stencil2) {
        (this.materials.stencil = new e.ShaderMaterial({
          uniforms: {
            res: {
              value: new e.Vector2(
                this.textures.grid.width,
                this.textures.grid.height
              ),
            },
            quadrant: { value: 0 },
          },
      ...
      for (var o = 0; o < 2; o++)
        for (var s = 0; s < 2; s++) {
          var l = o + 2 * s;
          0 !== l &&
            ((this.materials.stencil.uniforms.quadrant.value = l),
            i.stencil.setFunc(a.ALWAYS, l, 4294967295),
            r.render(
              this.scenes.stencil2,
              this.fullscreenCamera,
              this.textures.grid,
              !1
            ));
    ...
    updateGrid: function () {
      ...
      if (!n) {
        ...
        for (
          var o = new e.BufferGeometry(),
            s = this.textures.particleRead.width,
            l = new Float32Array(3 * s * s),
            c = new Float32Array(s * s),
            d = 0;
          d < s * s;
          d++
        )
          c[d] = d;
        o
          .addAttribute("position", new e.BufferAttribute(l, 3))
          .addAttribute("particleIndex", new e.BufferAttribute(c, 1)),
          (this.mapParticleToCellMesh = new e.Points(
            o,
            this.materials.mapParticle
          )),
          this.scenes.mapParticlesToGrid.add(this.mapParticleToCellMesh);
      }
      r.stencil.setFunc(i.EQUAL, 3, 4294967295),
        r.stencil.setOp(i.INCR, i.INCR, i.INCR),
        ...
        t.render(
          this.scenes.mapParticlesToGrid,
          this.fullscreenCamera,
          this.textures.grid,
          !1
        ),
    ...
    updateParticles: function () {
      ...
      i ||
        (i = this.materials.updateParticles =
          new e.ShaderMaterial({
            uniforms: {
              cellSize: { value: this.cellSize },
              gridPos: { value: this.broadphase.position },
              posTex: { value: null },
              particleTex2: { value: null },
              groupTex: { value: null },
              particleSprings: { value: null },
              particleSpringsDiagonal: { value: null },
              gridTex: { value: this.textures.grid.texture },
              explodeTex: { value: null },
              params1: { value: this.params1 },
              params2: { value: this.params2 },
              params3: { value: this.params3 },
              params4: { value: this.params4 },
              gravity: { value: this.gravity },
              applyForceMask: { value: this.applyForceMask },
              applyForce: { value: this.applyForce },
              applyForceMask2: { value: this.applyForceMask2 },
              applyForce2: { value: this.applyForce2 },
              applyGravityMask: { value: this.applyGravityMask },
              applyTorqueMaskAndCenterParticleId: {
                value: this.applyTorqueMaskAndCenterParticleId,
              },
              BOX_MIN: { value: this.boxMin },
              BOX_MAX: { value: this.boxMax },
              tearRadius: { value: 50 * this.radius },
              fixedTime: { value: 0.01 },
            },
            vertexShader: n,
            fragmentShader:
              a +
        ...
        (i.uniforms.particleSpringsDiagonal.value =
          this.textures.springsDiagonalRead.texture),
      ...
      if (!r) {
        (r = this.materials.mapParticleToExplode =
          new e.ShaderMaterial({
            uniforms: {
              posTex: { value: null },
              params2: { value: this.params2 },
              overrideExplodeParticleIndex: { value: -10 },
            },
            vertexShader:
              a +
        ...
        for (
          var i = new e.BufferGeometry(),
            n = this.textures.particleRead.width,
            o = new Float32Array(3 * n * n),
          ...
          s[l] = l;
        i
          .addAttribute("position", new e.BufferAttribute(o, 3))
          .addAttribute("particleIndex", new e.BufferAttribute(s, 1)),
          (this.mapParticleToExplodeMesh = new e.Points(i, r)),
          this.scenes.mapParticlesToExplode.add(this.mapParticleToExplodeMesh);
      }
      this.mapParticleToExplodeMesh.geometry.setDrawRange(
        0,
        this.particleCount
      ),
        (this.mapParticleToExplodeMesh.material = r),
        (r.uniforms.posTex.value = this.textures.particleRead.texture),
        t.render(
          this.scenes.mapParticlesToExplode,
          this.fullscreenCamera,
          this.textures.explode,
          !0
        ),
        (r.uniforms.posTex.value = null),
        (r.uniforms.overrideExplodeParticleIndex.value = -10),
    ...
    updateExplodedParticle: function () {
      ...
      r ||
        ...
        (r.uniforms.explodeTex.value = this.textures.explode.texture),
        (this.fullscreenQuad.material = r),
        t.render(
          this.scenes.fullscreen,
          this.fullscreenCamera,
          this.textures.exploded,
          !1
        ),
        (this.fullscreenQuad.material = null),
        (r.uniforms.explodeTex.value = null);
    },
    clearExploded: function () {
      this.flushDataToRenderTarget(
        this.textures.exploded,
        this.dataTextures.singlePixel
      );
    },
    ...
    readParticleData: function (t, r) {
      var i = this.renderer,
        o = (this.materials.renderSingleParticleDataToFullscreen =
      ...
      (this.fullscreenQuad.material = o),
        ...
        (o.uniforms.particleId.value = t),
        i.render(
          this.scenes.fullscreen,
          this.fullscreenCamera,
          this.textures.singleParticleData,
          !0
        ),
        (o.uniforms.particleTex.value = null),
        (this.fullscreenQuad.material = null),
        this.readByteData(r, this.textures.singleParticleData.texture);
    },
    readByteData: function (t, r) {
      var i = (this.materials.renderToReadableTexture =
      ...
      (this.fullscreenQuad.material = i),
        (i.uniforms.texture.value = r),
        this.renderer.render(
          this.scenes.fullscreen,
          this.fullscreenCamera,
          this.textures.fourUnsignedBytes,
          !0
        ),
        (i.uniforms.texture.value = null),
        (this.fullscreenQuad.material = null);
    ...
    tearSprings: function () {
      ...
      function o(e) {
        (i.fullscreenQuad.material = i.materials.tearSprings),
          (r.uniforms.explodeTex.value = i.textures.explode.texture),
          (r.uniforms.particleTex.value = i.textures.particleRead.texture),
          (r.uniforms.springsTex.value = i.textures[e + "Read"].texture),
          t.render(
            i.scenes.fullscreen,
            i.fullscreenCamera,
            i.textures[e + "Write"],
          ...
          (r.uniforms.springsTex.value = null),
          (r.uniforms.particleTex.value = null),
          (r.uniforms.explodeTex.value = null),
    ...
    addExplodeForce: function () {
      ...
      r ||
        ...
        (r.uniforms.explodeTex.value = this.textures.explode.texture),
        (r.uniforms.particleTex.value = this.textures.particleRead.texture),
        t.render(
          this.scenes.fullscreen,
          this.fullscreenCamera,
          this.textures.particleWrite,
    ...
    H = {
      ...
      levels: {
        loading: {
          ...
          music: "",
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 256, y: 224 } },
          killBoxes: [],
          portals: [
            {
              type: "timer",
        ...
        mario00: {
          ...
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 256, y: 240 } },
          killBoxes: [],
          portals: [
            {
              type: "normal",
        ...
        "mario11-part1": {
          backgroundColorPixel: [0, 0],
          music: "sound/world-1-1.mp3",
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 1770, y: 240 } },
          killBoxes: [],
          portals: [
            {
              color: [255, 0, 0, 255],
          ...
          gravity: { x: 0, y: -0.05 },
          enemyMovement: { type: "leftright", magnitude: 0.05, frequency: 0.1 },
          colorAnimations: [
            {
        ...
        "mario11-part2": {
          backgroundColorPixel: [0, 0],
          music: "sound/world-1-1.mp3",
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 1640, y: 240 } },
          killBoxes: [],
          portals: [
            {
              color: [255, 0, 0, 255],
        ...
        mario12: {
          ...
          music: "sound/02-underworld.mp3",
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 1476, y: 208 } },
          killBoxes: [],
          portals: [
            {
              color: [255, 255, 0, 255],
        ...
        "mario12-part2": {
          backgroundColorPixel: [22, 22],
          music: "sound/02-underworld.mp3",
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 1615, y: 208 } },
          killBoxes: [],
          portals: [
            {
              color: [255, 0, 0, 255],
        ...
        "mario12-part2-below": {
          backgroundColorPixel: [22, 22],
          music: "sound/02-underworld.mp3",
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 272, y: 208 } },
          killBoxes: [],
          portals: [
            {
              color: [255, 0, 0, 255],
        ...
        mario13: {
          backgroundColorPixel: [22, 22],
          music: "sound/world-1-1.mp3",
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 2628, y: 240 } },
          killBoxes: [],
          portals: [
            {
              color: [255, 0, 0, 255],
        ...
        mario14: {
          ...
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 1168, y: 199 } },
          killBoxes: [],
          portals: [
            {
              color: [255, 0, 0, 255],
          ...
          gravity: { x: 0, y: -0.05 },
          enemyMovement: { type: "rotate", magnitude: 0.1, frequency: 0.25 },
          colorAnimations: [
            {
              color: [255, 165, 66, 255],
              animation: [
        ...
        "mario14-part2": {
          backgroundColorPixel: [0, 60],
          music: "sound/04-castle.mp3",
          cameraBox: { min: { x: 0, y: 0 }, max: { x: 2554, y: 199 } },
          killBoxes: [],
          portals: [
            {
              color: [0, 255, 0, 255],
          ...
          gravity: { x: 0, y: -0.05 },
          enemyMovement: { type: "rotate", magnitude: 0.1, frequency: 1 },
          colorAnimations: [
            {
              color: [255, 165, 66, 255],
              animation: [
      ...
      sfx: [
        "sound/jump.mp3",
        "sound/smb_1-up.mp3",
        "sound/smb_bowserfalls.mp3",
        "sound/smb_bowserfire.mp3",
        "sound/smb_breakblock.mp3",
        "sound/smb_bump.mp3",
        "sound/smb_coin.mp3",
        "sound/smb_fireball.mp3",
        "sound/smb_fireworks.mp3",
        "sound/smb_flagpole.mp3",
        "sound/smb_gameover.mp3",
        "sound/smb_jump-small.mp3",
        "sound/smb_jump-super.mp3",
        "sound/smb_kick.mp3",
        "sound/smb_mariodie.mp3",
        "sound/smb_pause.mp3",
        "sound/smb_pipe.mp3",
        "sound/smb_powerup_appears.mp3",
        "sound/smb_powerup.mp3",
        "sound/smb_stage_clear.mp3",
        "sound/smb_stomp.mp3",
        "sound/smb_vine.mp3",
        "sound/smb_warning.mp3",
        "sound/smb_world_clear.mp3",
      ],
      music: {
        "sound/world-1-1.mp3": { loopEnd: 125.7, loopStart: 0.9 },
        "sound/02-underworld.mp3": { loopEnd: 50, loopStart: 0.1 },
        "sound/04-castle.mp3": { loopEnd: 48.6, loopStart: 0.6 },
      },
    },
  ...
  function ee(e, t, r) {
    if (e && le) {
      ...
      var i = 0.6 + t;
      (i = f(i, 0, 1)),
        e.playbackRate.linearRampToValueAtTime(i, le.currentTime + r);
    }
  }
  var te,
    re,
  ...
  function xe() {
    pe++,
      (document.getElementById("loadedPercent").innerText = parseInt(
        (pe / ue) * 100,
        10
      ));
  }
  ...
  if (
    ((he = !1),
    (ve = navigator.userAgent || navigator.vendor || window.opera),
    ...
    ((Te = document.getElementById("mobile-info")).style.display = "flex"),
      (Te.innerHTML += '<p><img src="jelly-mario.gif" width="60%"></p>');
  else if (
    (function () {
      var e = !1;
      try {
      ...
      r.bindTexture(r.TEXTURE_2D, i),
        r.texImage2D(r.TEXTURE_2D, 0, r.RGBA, 2, 2, 0, r.RGBA, r.FLOAT, null),
    ...
    Promise.all([
      ...
      (function () {
        ...
        (le = new e()),
          (ce = le.createGain()).gain.setValueAtTime(1, le.currentTime),
          ce.connect(le.destination),
          (document.getElementById("toggleSoundCheckbox").onchange =
            function () {
              var e = !!document.querySelector("#toggleSoundCheckbox:checked");
              ce.gain.setValueAtTime(e ? 1 : 0, le.currentTime);
            });
        var t = Object.keys(H.levels)
          .map((e) => H.levels[e].music)
          .filter((e) => !!e);
        t = H.sfx.concat(t);
        var r,
          i = (t = Array.from(new Set(t))).map(
            (e) => (
              (e = e),
              fe[e]
                ? Promise.resolve(fe[e])
                : (me(),
                  fetch(e)
      ...
      .then(function () {
        !(function () {
          (y = new e.WebGLRenderer()).setPixelRatio(1),
            ...
            (h = new e.Scene()),
            (V = new e.Vector2(512, 512)),
            (P = new c({
              maxSubSteps: 1,
              gravity: new e.Vector2(0, -0.05),
              renderer: y,
              maxParticles: 65536,
              radius: 0.003,
              stiffness: 3e3,
          ...
          P.radius;
          var t = 256 * P.radius;
          ((g = new e.OrthographicCamera(-1, 1, 1, -1, 0.1, 50)).position.z =
            t / 2),
            h.add(g),
            (function () {
              for (
                var t = new e.ShaderMaterial({
                    uniforms: {
                      ...
                      paletteTex: { value: R },
                      size: { value: Ae() },
                      playerParticleId: { value: ae },
                      cameraMin: { value: new e.Vector2() },
                      cameraMax: { value: new e.Vector2() },
                      time: { value: 0 },
                    },
                    vertexShader: W,
                    fragmentShader: Q,
                    defines: { PARTICLE_RESOLUTION: P.particleTextureSize },
                  }),
                  r = new Float32Array(P.maxParticles),
                  i = 0;
                i < P.maxParticles;
                i++
              )
              ...
              o
                .addAttribute("position", new e.BufferAttribute(a, 3))
                .addAttribute("particleIndex", new e.BufferAttribute(r, 1))
                .addAttribute("particleColor", new e.BufferAttribute(n, 1)),
                ((A = new e.Points(o, t)).frustumCulled = !1),
                h.add(A);
            })(),
            ...
            a
              .addAttribute("position", new e.BufferAttribute(n, 3))
              .addAttribute("particleColor", new e.BufferAttribute(i, 1)),
            ((C = new e.Points(a, r)).frustumCulled = !1),
            h.add(C),
            0,
            (B = {
              38: 0,
            ...
            window.addEventListener("keyup", function (e) {
              0 === B[e.keyCode] && 38 === e.keyCode && P.time,
                (B[e.keyCode] = 0),
                Ue();
            }),
            (function () {
              var t = new e.Vector2(),
                r = {
                  ...
                  mousemove: function (e) {
                    ...
                    t.set(e.pageX - r.left, e.pageY - r.top),
                      (t.x /= r.width),
                      (t.y /= r.height);
                  },
                  mousup: function () {},
        ...
        (be.style.display = "none"),
          (function () {
            if (!Y) return;
            ((b = new t()).domElement.style.position = "absolute"),
              (b.domElement.style.top = "0px"),
              Z.appendChild(b.domElement),
              (S = {
                paused: !1,
                gravity: P.gravity.y,
                level: E,
              ...
              (T = new r.GUI()).add(P, "stiffness", 0, 5e3, 0.1),
              T.add(P, "damping", 0, 100, 0.1),
              T.add(P, "drag", 0, 1, 0.01),
              T.add(P, "friction", 0, 10, 0.001),
              T.add(P, "fixedTimeStep", 0.001, 0.1, 0.001),
              T.add(S, "debugTimeScale", 0, 5, 0.01),
              T.add(S, "paused"),
              T.add(S, "gravity", -2, 2, 0.001).onChange(function (e) {
                P.gravity.y = e;
              }),
              T.add(S, "level", Object.keys(H.levels)).onChange(function (e) {
                Pe(e), Ce();
              }),
              T.add(S, "zoom", 1, 5, 0.01).onChange(Me);
          })(),
    ...
    (document.getElementById("mobile-info-message").innerText =
      "It seems like your device doesn't support WebGL. Sorry!"),
      (Te.style.display = "flex"),
      (Te.innerHTML += '<p><img src="jelly-mario.gif" width="60%"></p>');
  }
  function we(e, t, r, i) {
    (e[0] = t[0] * P.radius * 2),
      (e[1] = 2 * P.radius * i - t[1] * P.radius * 2);
  }
  function Pe(t, r) {
    if (
      ((E = t),
      ...
      if (
        !i
          .map((e) => e.width === _.width && e.height === _.height)
          .reduce((e, t) => e && t)
      ) {
        var n = i
          .map((e) => e.src + ": " + e.width + "x" + e.height)
          .join("\n");
    ...
    window.gtag &&
      ...
      P.reset(),
      P.gravity.copy(H.levels[t].gravity),
      P.applyForceMask2.set(0, 0, 0, 1),
      P.applyForce2.set(-0.03, 0),
      (ge = 0),
      (j = -100),
      (F = new Float32Array(4)),
      P.boxMin.set(0, 0),
      P.boxMax.set(2 * P.radius * _.width, 2 * P.radius * _.height),
      (w = _.height);
    var a = Ie(_),
      o = Ie(k),
      s = Ie(D),
    ...
    for (
      var m = [0, 0, 0, 0],
        x =
          4 *
          (H.levels[t].backgroundColorPixel[0] +
            _.width * H.levels[t].backgroundColorPixel[1]),
        f = 0;
      f < 4;
      f++
    )
    ...
    (te = 1),
      ...
      (ie |= re = 2),
      (ne |= re),
      P.applyGravityMask.set(0, 0, 1, 1),
      T.set(4278255360, te),
      T.set(4278190335, re),
      T.set(4294901760, ie),
      T.set(4294967295, ne);
    ...
    for (f = 0; f < _.width; f++)
      for (var C = 0; C < _.height; C++) {
        ...
        if (V !== m[0] || B !== m[1] || W !== m[2]) {
          var Z = u[_e];
          (he = T.get(Z)) === ie &&
            (S.set(Math.min(f, S.x), Math.min(C, S.y)),
            I.set(Math.max(f, I.x), Math.max(C, I.y))),
            T.has(Z) && A++;
        }
      }
    Y && console.log("Using " + v(A, P.maxParticles) + "% of particle texture"),
      (K.length = 0);
    for (f = 0; f < _.width; f++)
      for (C = 0; C < _.height; C++) {
        P.particleCount % 255 == 0 && P.addParticle(-100, -100, 0, 0, 0);
        var $;
        (V = a[($ = 4 * (_e = C * _.width + f)) + 0]),
          (B = a[$ + 1]),
          (W = a[$ + 2]),
          (Q = a[$ + 3]);
        if (V !== m[0] || B !== m[1] || W !== m[2]) {
          ...
          Z = u[_e];
          de && (me = Z);
          var xe = (h.indexOf(me) + 0.5) / h.length,
            ve = (l[$] / 255) * 0.01;
          if (T.has(Z)) {
            var he = T.get(Z),
    ...
    g.forEach(function (e, t) {
      var r,
        i = parseInt(t.split("_")[0], 10),
        n = parseInt(t.split("_")[1], 10);
      (i > 44 && i < 48 && n > 15 && n < 19) ||
        (void 0 !== (r = g.get(b(i, n + 1))) && P.connectParticles(e, r, !1),
        void 0 !== (r = g.get(b(i, n - 1))) && P.connectParticles(e, r, !1),
        void 0 !== (r = g.get(b(i + 1, n))) && P.connectParticles(e, r, !1),
        void 0 !== (r = g.get(b(i - 1, n))) && P.connectParticles(e, r, !1),
        void 0 !== (r = g.get(b(i - 1, n - 1))) && P.connectParticles(e, r, !0),
        void 0 !== (r = g.get(b(i + 1, n + 1))) && P.connectParticles(e, r, !0),
        void 0 !== (r = g.get(b(i - 1, n + 1))) && P.connectParticles(e, r, !0),
        void 0 !== (r = g.get(b(i + 1, n - 1))) &&
          P.connectParticles(e, r, !0));
    }),
      (L = new Map()),
      H.levels[t].portals.forEach(function (e) {
    ...
    (ae = g.get(b(Te, Pe))),
      (P.centerParticleIndex = ae),
      P.applyTorqueMaskAndCenterParticleId.set(0, 0, 1, ae),
      Y && console.log("Player particle: " + ae);
    ...
    (oe = g.get(b(Ae, Ce))),
      (se = g.get(b(Ae, Me))),
      (oe && se) ||
        (console.error("Stretch particle not found!"), (oe = se = -1)),
      (q = []),
      (N = I.x - S.x + 1),
      (X = I.y - S.y + 1);
    ...
    y.setClearColor(Ee, 1),
      (R = new e.DataTexture(
        new Uint8Array(4 * h.length * 8),
        8,
        h.length,
        e.RGBAFormat
      ));
    var _e,
      De = H.levels[t].colorAnimations || [];
    (h.forEach(function (e, t) {
      ...
      if (o)
        o.animation.forEach(function (e, r) {
          (R.image.data[4 * (8 * t + r) + 0] = e[0]),
            (R.image.data[4 * (8 * t + r) + 1] = e[1]),
            (R.image.data[4 * (8 * t + r) + 2] = e[2]),
            (R.image.data[4 * (8 * t + r) + 3] = e[3]);
        });
      else
        for (var s = 0; s < 8; s++)
          (R.image.data[4 * (8 * t + s) + 0] = r),
            (R.image.data[4 * (8 * t + s) + 1] = i),
            (R.image.data[4 * (8 * t + s) + 2] = n),
            (R.image.data[4 * (8 * t + s) + 3] = a);
    }),
    (R.needsUpdate = !0),
    r) &&
      (we((_e = [0, 0]), r, _.width, _.height),
      P.singleStep(),
      (function (e, t) {
    ...
    !(function (e) {
      if (!O && H.levels[e].music.length) {
        ...
        (O.buffer = fe[t]),
          ...
          (O.loop = !0),
          H.music[t] &&
            ((O.loopEnd = H.music[t].loopEnd),
            (O.loopStart = H.music[t].loopStart)),
          O.start(le.currentTime, O.loopStart),
          ee(O, 0);
      }
    })(t),
      (g = null);
  ...
  function Ie(e) {
    ...
    return (
      ...
      r.getImageData(0, 0, e.width, e.height).data
    );
  }
  function Ae() {
  ...
  function Ce() {
    (C.material.uniforms.size.value = A.material.uniforms.size.value = Ae()),
      (C.material.uniforms.playerParticleId.value =
        A.material.uniforms.playerParticleId.value =
          ae),
      (C.material.uniforms.paletteTex.value =
        A.material.uniforms.paletteTex.value =
          R),
      Ve();
    for (var e = 0; e < P.particleCount; e++)
      (A.geometry.attributes.particleColor.array[e] = M[e]),
        ...
        (A.geometry.attributes.position.array[3 * e + 2] = J[e]);
    ...
    for (e = 0; e < I; e++)
      if (4 * e < K.length) {
        var t = K[4 * e],
          ...
          i = K[4 * e + 2],
          n = K[4 * e + 3];
        (C.geometry.attributes.particleColor.array[e] = n),
          (C.geometry.attributes.position.array[3 * e + 0] = t),
          (C.geometry.attributes.position.array[3 * e + 1] = r),
          (C.geometry.attributes.position.array[3 * e + 2] = i);
      } else
        (C.geometry.attributes.position.array[3 * e + 0] = 0),
          (C.geometry.attributes.position.array[3 * e + 1] = 0);
    for (var a in ((K.length = 0), A.geometry.attributes))
      A.geometry.attributes[a].needsUpdate = !0;
    for (var a in C.geometry.attributes)
      C.geometry.attributes[a].needsUpdate = !0;
  }
  function Me() {
    var e = 480 * P.radius,
      t = 512 * P.radius;
    ...
    var i = Z.getBoundingClientRect(),
      ...
      a = i.height;
    n / a > 256 / 240
      ? y.setSize((256 / 240) * a, a)
      : y.setSize(n, n / (256 / 240)),
      (C.material.uniforms.size.value = A.material.uniforms.size.value = Ae()),
      Ve();
  }
  function Ve() {
    ...
    r.multiplyScalar(2 * P.radius),
      i.multiplyScalar(2 * P.radius),
      r.set(r.x + e / 2, r.y + t / 2),
      i.set(i.x - e / 2, i.y - t / 2),
      r.x > i.x && (r.x = i.x = 0.5 * (r.x + i.x)),
      r.y > i.y && (r.y = i.y = 0.5 * (r.y + i.y)),
      C.material.uniforms.cameraMin.value.copy(r),
      C.material.uniforms.cameraMax.value.copy(i);
  }
  function Re(t) {
    requestAnimationFrame(Re),
      (function (e) {
        P.time - j > 0.3 && (P.params4.y = 0);
        ...
        if (t)
          if ("rotate" == t.type) {
            var r = t.magnitude,
              i = t.frequency;
            P.applyForce2
              .set(Math.sin(i * P.time), Math.cos(i * P.time))
              .multiplyScalar(r);
          } else if ("leftright" == t.type) {
            var r = t.magnitude,
              i = t.frequency;
            P.applyForce2
              .set((Math.floor(i * P.time) % 2) * 2 - 1, 0)
              .multiplyScalar(r);
          }
      ...
      (C.material.uniforms.particleTex.value =
        A.material.uniforms.particleTex.value =
          P.particleTexture),
      (C.material.uniforms.time.value = A.material.uniforms.time.value =
        P.time),
      y.render(h, g),
      (function () {
        var t = P.time;
        ...
        if (P.hasExploded())
          return (
            ...
            Ue(),
            Se(),
            void ze("sound/smb_fireworks.mp3", function () {
              setTimeout(function () {
        ...
        if (r)
          null === Ee
            ? (Ee = t)
            : t - Ee > r.timeSeconds && (Pe(r.destinationLevel), Ce());
        else {
          P.readParticleData(ae, F), ee(O, ke(), 1);
          var i = new e.Vector2(
              f(Math.floor(F[0] / (2 * P.radius)), 0, G.width),
              f(G.height - Math.floor(F[1] / (2 * P.radius)), 0, G.width)
            ),
            n = z[i.x + G.width * i.y],
            a = null;
          if (
            (H.levels[E].portals.forEach(function (e) {
              var t = new Uint32Array(new Uint8Array(e.color).buffer);
              n === t[0] && (a = e);
            }),
            a && "die" === a.type)
          )
            return void P.explodeParticle(ae);
          if (a) {
            var o = function () {
  ...
  function Ue() {
    if (_e) P.applyForce.set(0, 0), P.params4.set(0, 0, 0, 0);
      ...
      (P.params4.x = -1.2 * (B[39] - B[37])),
        P.applyForceMask.set(0, 0, 1, 0),
        P.applyForce.set(0.1 * (B[39] - B[37]), 0 * (B[38] - B[40])),
        P.time - j > 1 &&
          B[38] &&
          ((P.params4.y = -0.5 * Math.min(0, -(B[38] - B[40]))),
          (P.params4.z = ae),
          (P.params4.w = se),
          (j = P.time),
          ze("sound/jump.mp3"));
